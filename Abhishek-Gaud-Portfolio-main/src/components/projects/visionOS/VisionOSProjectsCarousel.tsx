    ...
    <div className="relative w-full flex flex-col items-center justify-center">
      ...
      >
        ...
        <div
          ...
          "
        >
          <img src="/harsh.jpg" className="w-8 h-8 rounded-full" alt="Harsh Vishwakarma" />
          <div className="text-sm">
            <p className="font-semibold text-white">Harsh Vishwakarma</p>
            <p className="text-xs text-white/60">Developer • AI/ML Enthusiast</p>
          </div>
        </div>
      </div>
    </div>
